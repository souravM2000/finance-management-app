...
public class TrackingDeleteController {
    ...
    public void deleteCategory(@RequestParam String categoryId) throws CustomException {
        try{
    ...
    public void deleteHashTag(@RequestParam String transactionId,
